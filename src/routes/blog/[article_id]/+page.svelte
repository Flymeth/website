...
<Header bannerURL={article.metadata.coverURL}>
	...
	<p style="mix-blend-mode: difference;">{article.metadata.description}</p>
</Header>
<main>
	<ul id="article-info">
...
<footer>
	<h2>Déjà fini ?</h2>
	<p>
		J'espère que tu as apprécié mon travail! Si c'est le cas, n'hésite pas à
	...
	{#if article.metadata.ressources}
		<h2>Ressources</h2>
		<p>
			Ci-dessous sont listés les différentes ressources que j'ai utilisées
