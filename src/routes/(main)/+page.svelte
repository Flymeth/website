...
<main id="index">
	<section id="me">
		...
		<p use:reveal>
			Je m'appelle Johan, j'ai {new Date().getFullYear() - 2005} ans, et je
			suis étudiant en digital.
		</p>
		<p use:reveal>
			Depuis plus de 4 ans je suis passionné par le monde du digital. Que
			ce soit dans la création d'identité visuelle, de conception/création
			web, référrencement et développement web, je suis dévoué à ma tâche
			afin de pouvoir proposer un résultat digne de mes compétences à mes
			clients.
		</p>
		<p use:reveal>
	...
	<section id="tech">
		...
		<ol>
			...
			<li>
				<TechCategory
					name="CMS & Outils"
					icons={[wordpress, elementor, shopify]}
				/>
			</li>
			<li>
			...
			<li>
				<TechCategory
					name="Autres"
					icons={[discordDev, unity, flstudio]}
					on:iconClicked={({ detail: { icon } }) => {
	...
	<section id="showoff">
		<h2>Mes projets</h2>
		<p>
			Que ce soit pour mes études ou par passe-temps personnel, j'ai
			réalisé de nombreux projets dont les meilleurs sont répertoriés sur <a
	...
	<section id="hobbies">
		...
		<p>
			Certes le monde du digital est une passion chez moi, mais cela ne
			veut pas dire que je ne fais que cela durant mon temps libre.
		</p>
		<ul>
			<li>
