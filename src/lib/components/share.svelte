  ...
  <li class="twitter x" style="--theme:#1DA1F2;">
    <a
      ...
      href="https://twitter.com/intent/tweet?text={encodeURIComponent(
        sharingInformation.description
      )}&url={encodeURIComponent(sharingInformation.link)}"
    >
      <Fa icon={faTwitter} />
    </a>
  </li>
  ...
  <li class="linkedin" style="--theme:#0077B5;">
    <a
      ...
      href="https://www.linkedin.com/shareArticle/?mini=true&url={encodeURIComponent(
        sharingInformation.link
      )}&title={sharingInformation.title}&summary={encodeURIComponent(
        sharingInformation.description
      )}&source={encodeURIComponent(sharingInformation.link)}"
    >
